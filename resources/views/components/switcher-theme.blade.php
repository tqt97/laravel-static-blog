<div class="flex flex-col justify-center ml-3 bg-gray-50 hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-800  rounded-full" @click="darkMode=!darkMode">
    <input type="checkbox" name="light-switch" class="light-switch sr-only" />
    <label class="relative cursor-pointer p-2" for="light-switch">
        {{-- <svg class="dark:hidden text-gray-900 fill-gray-950" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="size-6 hidden dark:block text-yellow-500">
        ...
        {{-- <svg class="hidden dark:block text-gray-900 fill-gray-950" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
