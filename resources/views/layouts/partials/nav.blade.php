<nav x-data="{ isOpen: false }" class="sticky top-0 z-50 sm:px-2 bg-white shadow dark:bg-gray-950">
    <div class="max-w-7xl py-3 mx-auto md:flex">
        <div class="flex items-center justify-between px-2 md:px-0">
            <a href="#" class="font-bold text-3xl text-gray-800 dark:text-white">
        ...
        <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
            class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out 0 md:mt-0 md:p-0 md:top-0 md:relative md:opacity-100 md:translate-x-0 md:flex md:items-center md:justify-between">
            ...
            <div class="block md:flex items-center gap-6">
                <x-switcher-theme />
                @include('layouts.partials.btn-search')
                <button
